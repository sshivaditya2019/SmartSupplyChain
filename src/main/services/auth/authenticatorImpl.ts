...
import { ConcurrentActionHandler } from '../utils/concurrentActionHandler';
...
export class AuthenticatorImpl implements Authenticator {
  ...
  public constructor(
    ...
    this._events.setOAuthDetails(
      this._loginState,
      this._logoutState,
      this._configuration.logoutCallbackPath
    );
  }
  ...
  private _setupCallbacks() {
    this._swapAuthorizationCodeForTokens =
      this._swapAuthorizationCodeForTokens.bind(this);
